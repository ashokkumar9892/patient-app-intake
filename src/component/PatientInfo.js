...
const PatientInfo = ({handleChangeIndex,register}) => {
...
<div className="form-group col-md-5">
    ...
    <select className="form-control  "{...register("CurrentMedicine")}>
      <option>yes</option>
      <option>No</option>
  ...
  <div className="form-group">
    ...
    <textarea className="form-control" rows="3" {...register("CurrentMedicine.list")}></textarea>
  </div>
